...
setPar()
plot(SelByYear, x=2006:2015, ylim=c(min( CISelByYear), max( CISelByYear)), xlab="Year", ylab = "Selection gradient")
abline(h=0)
...
setPar()
plot(SelByYearRho, x=2006:2015, ylim=c(min( CISelByYearRho), max( CISelByYearRho)), xlab="Year", ylab = "Selection gradient on $\\rho$")
abline(h=0)
sd(SelByYearRho)
...
setPar()
plot(SelByYearPhi, x=2006:2015, ylim=c(min( CISelByYearPhi, na.rm=TRUE), max( CISelByYearPhi, na.rm=TRUE)), xlab="Year", ylab = "Selection gradient on $\\phi$")
abline(h=0)
