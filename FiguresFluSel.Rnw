...
x <- barplot(Betas, beside=TRUE, ylim=c(min(BetasCI),max(BetasCI)),names.arg = c("Postive selection years","Negative selection years"), legend.text = c("Phenotypic","Environmental","Genetic"), color = c(rgb(59,52,120,maxColorValue = 255),rgb(39,113,93,maxColorValue = 255),rgb(225,156,57,maxColorValue = 255)))
abline(h=0)
arrows(x0 = x, y0=BetasCI[1,],y1=BetasCI[2,],angle = 90,code = 3)
mtext(side=2, "Selection gradients", line=4, las=0, cex=szax*szgr)
