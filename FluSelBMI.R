...
polygon(x=c(2005,2016,2016,2005),y=c(Zlowm0all,Zlowm0all, Zhighm0all, Zhighm0all),
        fillOddEven = TRUE, col=rgb(0.1,0.1,0.1,0.5), lty=2)
...
polygon(x=c(2005,2016,2016,2005),y=c(Zlowm0allRho,Zlowm0allRho, Zhighm0allRho, Zhighm0allRho),
        fillOddEven = TRUE, col=rgb(0.1,0.1,0.1,0.5), lty=2)
